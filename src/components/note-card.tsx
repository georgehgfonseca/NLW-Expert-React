...
export function NoteCard({ onNoteDeleted, note }: NoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="flex flex-col rounded-md bg-slate-800 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 hover:cursor-pointer text-left focus:ring-2 focus:ring-lime-400 outline-none">
